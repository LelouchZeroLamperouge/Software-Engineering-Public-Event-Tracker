...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    function validateDateTime($dateTime, $format = 'Y-m-d H:i:s') {
        ...
        // Check if the input matches the format and if it's a valid date
    ...
    $stmt->bind_param("sssssiiss",$eventName,$eventDescr,$eventStreet,$eventCity,$eventZip,$creator,$eventCat, $eventDate,$website);
    $stmt->execute();
    }
}
        ...
        <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
          ...
          <div class="box3">
            <fieldset>
                ...
                <select class="col-form-label mt-4" name="Cat" id="Cat" name="event_cat">
