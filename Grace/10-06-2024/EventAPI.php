<?php
    ...
    # NOTE: GET DATA FOR DB FROM CREATE EVENT PAGE WHEN USER CREATES EVENT
    ...
    $stmt->bind_param("ssiss",$event_name,$event_descr,$street_add,$city,$zipcode,$creator,$category, $when,$website);
    $stmt->execute();
