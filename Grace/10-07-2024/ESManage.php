    ...
    <main class="box2">
        <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
          ...
          if ($result->num_rows > 0) {
              ...
              echo "<table class='table table-hover' id='ET' table border='1' cellpadding='10'>";
              while ($row = $result->fetch_assoc()) {
                  echo "<tr>";
                  echo "<td>" . $row['EVENT_NAME'] . "</td>";
                  echo "<td>" . $row['EVENT_DESCR'] . "</td>";
                  echo "<td><a href='edit_record.php?id=" . $row['EVENT_ID'] . "'>Edit</a></td>";
              }
